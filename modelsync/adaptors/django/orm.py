...
from modelsync.core.ast_parser import ASTParser
from modelsync.core.classes import FieldNode, ModelNode
from modelsync.core.event_bus import EventBus
from modelsync.core.exceptions import (ModelSyncError, MultipleObjectsReturned,
...
class DjangoORMAdapter(AbstractORMProvider):
    ...
    def get_or_create(
        ...
        if created:
            ...
            try:
                ...
                raise ModelSyncError(detail=str(e))
    ...
    def register_event_signals(self, event_bus: EventBus) -> None:
        ...
        for model in registry._models_config.keys():
            ...
            uid_save = f"modelsync:{model_name}:post_save"
            uid_delete = f"modelsync:{model_name}:post_delete"
