...
from modelsync.adaptors.django.exception_handler import \
    explicit_exception_handler
from modelsync.adaptors.django.permissions import ModelSyncViewAccessGate
from modelsync.core.exceptions import ModelSyncError
from modelsync.core.interfaces import AbstractEventEmitter
from modelsync.core.process_request import RequestProcessor
...
class ModelListView(APIView):
    ...
    permission_classes = [ModelSyncViewAccessGate]
