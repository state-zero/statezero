...
from modelsync.core.interfaces import AbstractEventEmitter, AbstractORMProvider
from modelsync.core.types import ActionType, ORMModel, ORMQuerySet
...
class EventBus:
    ...
    def set_registry(self, registry):
        ...
        from modelsync.core.config import Registry
